...
/**
 * Detects the bank identifier from a string (e.g., from receipt result or database).
 * @param {string} str The bank name or identifier to detect.
 * @returns {string} The normalized bank key from the BANKS object.
 */
export function detectBank(str) {
    if (!str) return "outro";
