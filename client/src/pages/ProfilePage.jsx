...
import { Lock, User, Mail, ShieldAlert, Loader2, CheckCircle, AlertCircle, Trash2, LockIcon, InfoIcon, Eye, EyeOff } from 'lucide-react';
    ...
    return (
        ...
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in zoom-in-80 duration-300">
            <header className="mb-8">
                ...
                <p className="text-zinc-400">Gerencie as informações da sua conta.</p>
            </header>
            <div class="bg-zinc-800 border border-green-500/30 rounded-3xl p-6 md:p-8">
                <div class="flex items-center gap-3 ">
                    <div class="h-[1px] flex-1 bg-gradient-to-r from-green-500/40 to-transparent"></div>
                    <span class="text-[13px] uppercase font-bold tracking-[0.3em] text-on-surface-variant/60">Informações da Conta</span>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div class="space-y-2">
                        ...
                        <div class="bg-surface-container-lowest border border-outline-variant/10 rounded-lg px-5 py-4 text-on-surface/40 text-sm flex justify-between items-center cursor-not-allowed">
                            {profile?.username ?? ''}
                            <LockIcon size={13} />
                        </div>
                    </div>
                ...
                <div class="space-y-6 mt-12">
                    <div class="flex items-center gap-3">
                        <span class="text-[13px] uppercase font-bold tracking-[0.3em] text-on-surface-variant/60">Trocar Senha</span>
                        <div class="h-[1px] flex-1 bg-gradient-to-r from-transparent to-green-500/40"></div>
                    </div>
            ...
            {deleteModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setDeleteModal(false)}>
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-white text-center mb-1">Excluir sua conta?</h3>
                        <p className="text-sm text-zinc-400 text-center mb-5">
                            Todos os comprovantes serão excluídos permanentemente. Esta ação não pode ser desfeita.
                        </p>
                        ...
                        {deleteStatus.state === 'error' && (
                            <Error message={deleteStatus.message} />
                        )}
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 h-10 rounded-lg bg-red-600 hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors flex items-center justify-center gap-2"
                            >
