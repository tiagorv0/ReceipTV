...
const CalendarDayCell = ({
    ...
    const cellColors = !isCurrentMonth
        ? 'opacity-40 cursor-default bg-zinc-800/30'
        : hasData
        ? 'bg-green-500/20 hover:bg-zinc-700 cursor-pointer'
        : 'bg-zinc-800/50 cursor-default';
        ...
        >
            ...
            {hasData && (
                <div className="md:hidden mt-auto flex justify-center">
                    <span className="bg-green-500 text-white text-xs rounded-full px-1.5 py-0.5 leading-none font-medium">
                        {dayData.count}
                    </span>
                </div>
            )}
            ...
            {hasData && (
                <div className="hidden md:flex flex-col gap-0.5 mt-auto">
                    <span className="bg-green-500 text-white text-xs rounded-full px-1.5 py-0.5 leading-none font-medium self-start">
